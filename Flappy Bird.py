...
bird_up = pygame.image.load("Flappy1.png")
bird_down = pygame.image.load("Flappy2.png")
bird_mid = pygame.image.load("Flappy3.png")
...
game_over = False
over_img = pygame.image.load("Start.png").convert_alpha ()
